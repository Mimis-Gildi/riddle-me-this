...
:onEngineering: https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v2.1.0/OnEngineering.pdf[Engineering Résumé]
:onCreativity: https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v2.1.0/OnCreativity.pdf[Creative Résumé]
:onLeadership: https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v2.1.0/OnLeadership.pdf[Leadership Résumé]
