...
:release: https://github.com/Mimis-Gildi/riddle-me-this/releases/tag/v2.0.0[v2.0.0,window=_blank]
:onEngineering: https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v2.0.0/OnEngineering.pdf[Engineering Résumé,window=_blank]
:onCreativity: https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v2.0.0/OnCreativity.pdf[Creative Résumé,window=_blank]
:onLeadership: https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v2.0.0/OnLeadership.pdf[Leadership Résumé,window=_blank]
