...
:release: https://github.com/Mimis-Gildi/riddle-me-this/releases/tag/v6.0.17[v6.0.17,window=_blank]
:resume: https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v6.0.17/VadimKuhay-Resume.pdf[Vadim Kuhay Résumé,window=_blank]
