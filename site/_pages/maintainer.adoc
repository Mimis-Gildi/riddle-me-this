...
:release: https://github.com/Mimis-Gildi/riddle-me-this/releases/tag/v6.0.14[v6.0.14,window=_blank]
:resume: https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v6.0.14/VadimKuhay-Resume.pdf[Vadim Kuhay Résumé,window=_blank]
