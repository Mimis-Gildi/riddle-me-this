...
:release: https://github.com/Mimis-Gildi/riddle-me-this/releases/tag/v1.8.0[v1.8.0,window=_blank]
:onEngineering: https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v1.8.0/OnEngineering.pdf[Engineering Résumé]
:onCreativity: https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v1.8.0/OnCreativity.pdf[Creative Résumé]
:onLeadership: https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v1.8.0/OnLeadership.pdf[Leadership Résumé]
