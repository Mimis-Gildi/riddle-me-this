...
:release: https://github.com/Mimis-Gildi/riddle-me-this/releases/tag/v4.5.0[v4.5.0,window=_blank]
:resume: https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v4.5.0/VadimKuhay-Resume.pdf[Vadim Kuhay Résumé,window=_blank]
