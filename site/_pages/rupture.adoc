...
image::Athenas-Only-Daughter-Banner.png[Athena's Only Daughter]
...
|===
a|
image::Athena-Young-Adult-Cover.png[Athena a Young Adult,300]
a|
...
a|
image::Athena-In-Armour-Licensed-Reproduction-Crop.png[Athena Mother looking over her Child,300]
...
→ link:{site-baseurl}/series/[Back to Curated Series]
