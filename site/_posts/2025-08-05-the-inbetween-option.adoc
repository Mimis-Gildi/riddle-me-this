...
:new-founders: link:{site-baseurl}/adventures/2025/08/04/new-founders-compendium.html
...
:contra: https://contra.com/[**Contra**,window=_blank,opts=nofollow]
:upwork-enterprise: https://www.upwork.com/enterprise/[**Upwork Enterprise**,window=_blank,opts=nofollow]
:cal-com: https://cal.com/[**Cal.com**,window=_blank,opts=nofollow]
:toggle-track: https://toggl.com/[**Toggle Track**,window=_blank,opts=nofollow]
:wise: https://wise.com/[Wise,window=_blank,opts=nofollow]
:mercury: https://mercury.com/[Mercury,window=_blank,opts=nofollow]
:documenso: https://documenso.com/[**Documenso**,window=_blank,opts=nofollow]
:freshbooks: https://www.freshbooks.com/[**FreshBooks**,window=_blank,opts=nofollow]
:bench: https://www.bench.co/[**Bench**,window=_blank,opts=nofollow]
:loom: https://www.loom.com/[**Loom**,window=_blank,opts=nofollow]
:notion: https://www.notion.com/[**Notion**,window=_blank,opts=nofollow]
:linear: https://linear.app/[**Linear**,window=_blank,opts=nofollow]
...
* {contra} -- High-end enterprise overflow. (not yet tested)
* {upwork-enterprise} -- Yes, really.
They're desperate! (won't test)
* *_Your Blog_* -- Write about AI failures, they'll find you! (link:{site-baseurl}/series/[I have,window=_blank])
* **LinkedIn** -- But talk about solutions, not your availability. (questionable)

=== Operations:

* {cal-com} -- Professional booking without the SaaS price. (love it!, can run your own!)
* {toggle-track} -- Bulletproof time tracking with reporting.
* **{wise} / {mercury}** -- International payments without the BS.
* {documenso} -- Open source contract signing.
* {freshbooks} -- Simple invoicing that works.
* {bench} -- Bookkeeping without thinking.

=== Positioning Tools:

* **GitHub** -- Your portfolio of fixes, _**not** just code_.
* {loom} -- Async explanations save meeting time.
* {notion} -- Client portals that don't suck.
* {linear} -- Show them what real project management looks like.
