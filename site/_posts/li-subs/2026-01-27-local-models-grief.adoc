...
.Did you know that a local model with Claude Code is a latest watercooler trend?
image::/riddle-me-this/assets/images/models/local-model-corporate-reality.png[Local Model versus Hosted Model]
{nbsp}
...
https://www.nvidia.com/en-us/products/workstations/dgx-spark/[NVIDIA DGX Spark,window=_blank] is about $4k per unit (ballpark) and needs a place to live.
...
https://docs.ollama.com/context-length[Increase it,window=_blank] as the docs say, or with `/set parameter num_ctx`.
...
We're going to use https://huggingface.co/Qwen/Qwen3-30B-A3B-Thinking-2507[Qwen3-30B-A3B-Thinking-2507,window=_blank] because:
...
as long as you treat it as research and keep your expectations realistic.
When there is no other option available:

- you can still learn hands-on about some of the latest and greatest trends in Agenic AI;
- and you can still follow my community tutorials on local orchestration setup.

(And yes: if you're doing this at work, get buy-in and keep a clear data boundary.)

See my other article where I mention "digital identity" "trails under highways": +
https://mimis-gildi.github.io/riddle-me-this/reflections/2026/01/25/plebs-discovered-claude.html[I Figured It Out -- The AI Hysteria,window=_blank].
