...
:evolution-playbook: link:{site-baseurl}/adventures/2023/07/05/integrated-ai-evolution.html
...
:tnm-bedrocking: link:{site-baseurl}/adventures/2025/08/05/the-inbetween-option.html#the-three-consulting-models-that-work
:google-ai-studio: https://aistudio.google.com/[Google AI Studio (free prototyping),window=_blank,opts=nofollow]
:vercel-v0: https://v0.dev/[Vercel v0 (rapid UI),window=_blank,opts=nofollow]
:supabase: https://supabase.com/[Supabase (auth + database),window=_blank,opts=nofollow]
:stripe-payment: https://stripe.com/[Stripe (payment before product),window=_blank,opts=nofollow]
:make-com: https://www.make.com/[Make.com,window=_blank,opts=nofollow]
:zapier: https://zapier.com/[Zapier,window=_blank,opts=nofollow]
...
* {supabase}.
* {stripe-payment}.
* {make-com} / {zapier} (glue it together).
