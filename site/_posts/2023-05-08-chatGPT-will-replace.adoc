...
When a person has a conversation with an LLM like {chatgpt},
it is not two thinking beings conversing and arriving at truth through dialectics.
...
*Conclusion:* *_Plausible Bullshit (PB)._* As long as *_any_* ML
is in the loop -- the entire product is stochastic, i.e., PB.
