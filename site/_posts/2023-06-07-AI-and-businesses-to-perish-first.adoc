...
:previous-article: link:{site-baseurl}/reflections/2023/05/11/chatGPT-omen-new-era.html[previous article,window=_blank]
...
In the {previous-article}, I discussed how AI advancements could potentially streamline, and in some cases,
