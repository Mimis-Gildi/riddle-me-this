...
:active-inference: https://baicsworkshop.github.io/pdf/BAICS_37.pdf[Active Inference,window=_blank]
...
:db-dolly-hf: https://www.databricks.com/blog/2023/04/12/dolly-first-open-commercially-viable-instruction-tuned-llm[Databricks blog post,window=_blank]
:open-assistant: https://github.com/LAION-AI/Open-Assistant[Open Assistant (defunct),window=_blank]
...
:mail-rdd13r-no-subj: mailto:rIdd13r@pm.me[Riddler at PM]
:revisit-article: link:{site-baseurl}/adventures/2025/08/18/years-late-confirmation.html[MIT Says Your AI Stinks. Here’s Why. And how to fix.,window=_blank]
:revisit-fn: footnote:[Findings are revisited in this article '{revisit-article}'. Please, feel free to reach out ({mail-rdd13r-no-subj}) if you need a competent assesment of your AI strategy.]
...
[#img-space,link={rdd13r-gh-io-url}]
image::dall-e-rdd13r-space.png[Picture of the author in space rendered DALL-E as prompted by Tillie,align=center,width=800]
...
Likewise, Northern is not an organization but a grassroots tradition: just a vibrant and decentralized social network of {hacker-culture-url}[Hacker Cliques,window=_blank]
...
This and many such communities we frequent are about celebrating the roots of the authentic {hacker-culture}.
...
[#img-zowah]
image::dada-and-zowah.png[Rdd13r with his infant daughter studying music,1200]
...
and did not allow for the fidelity that {active-inference} models claim to provide.
...
It is developed by Databricks ({db-dolly-hf}) and can be accessed at {db-dolly} on GitHub.
...
(AGAIN Collective of a Mímis Gildi scene), where it sparked a deep and heated debate.{revisit-fn}
...
Ask to friend `riddler9297` for an invitation.
