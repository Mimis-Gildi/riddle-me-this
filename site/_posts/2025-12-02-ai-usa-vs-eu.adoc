...
:ai-learning: link:{site-baseurl}/reflections/2025/11/24/fastest-ai-adoption.html[I recommend studying on this infrastructure,window=_blank]
:jb-on-llms: https://youtu.be/CWgZXpGWvtg
:jb-on-llms-video: {jb-on-llms}[Why LLMs Are Finally Useful,window=_blank]
:amazon-bedrock-oss: https://aws.amazon.com/blogs/aws/amazon-bedrock-adds-fully-managed-open-weight-models/[Amazon Bedrock adds 18 fully managed open weight models...,window=_blank]
:mistral-3: https://mistral.ai/news/mistral-3[Mistral 3]
:qwen3: https://github.com/QwenLM/Qwen3[Qwen3]
:advent-of-code: https://adventofcode.com/[Advent of Code 2025]
...
image::EU-vs-USA-AI-Adoption-Button.png[EU is many small trams moving things around while in the USA we have a huge loco crashing through the track and nothing can move it]
...
image::US-AI-Progress-Button.png[The USA is a huge loco crashing through the tracks on infrastructure that can't support it]
...
image::EU-AI-Progress-Button.png[The EU business doesn't hold breath for massive and instead profits well on the available today]
...
In 2023, I watched Ukrainian logistics networks solve an impossible problem:
keep a country fighting with fractured supply chains.
Their solution wasn't centralized control.
It was a distributed commitment -- thousands of small makers,
validation only at transaction commit, late onboarding welcome.

By 2025, that pattern migrated south.
Rheinmetall's supply chain looks nothing like 2022.
Instead of a few large sources, they now coordinate with 1,250+ small shops.
Monsters like Rheinmetall, KMDB, and BAE operate something like a single organism with thousands of small manufacturers;
servicing equipment nobody designed, building systems nobody envisioned.
...
The world's leading economic research institutions are already writing books about it.
...
No "AI strategy depends on OpenAI's roadmap." No chasing the latest model -- chasing profit instead.

== Why doesn't anyone talk about this?

Because it's *boring*.
"German manufacturer deploys a fine-tuned 7B model with an 11-person team" doesn't make headlines.
"EU announces €200B AI gigafactory initiative" does.

But one of these approaches actually works at an enterprise scale.
The other creates great slide decks.
One of these ways survives the AI bubble crash.
The other does not.
...
image::JetBrainsOnLLMs.png[The proper history of LLMs]
...
. {amazon-bedrock-oss} -- match self-hosted folks.

The EU-specific boosters:

. {mistral-3} is out -- can power any needs now (all three will run in your lab);
. {qwen3} is out -- my personal full-power favorites (if you have the hardware).

_Note: Requirements for Qwen3-30B-A3B-Thinking-2507 are overstated -- try it before you panic._

Fun stuff:

JetBrains {advent-of-code} is 3 days in!
