...
:ai-learning: link:/riddle-me-this/reflections/2025/11/24/fastest-ai-adoption.html[I recommend studying on this infrastructure,target=_blank]
:jb-on-llms: https://youtu.be/CWgZXpGWvtg
:jb-on-llms-video: {jb-on-llms}[Why LLMs Are Finally Useful,target=_blank]
...
. https://aws.amazon.com/blogs/aws/amazon-bedrock-adds-fully-managed-open-weight-models/[Amazon Bedrock adds 18 fully managed open weight models...,target=_blank] -- match self-hosted folks.
