...
header:
  ...
  actions:
    - label: "Résumé (GitHub)"
      url: https://github.com/Mimis-Gildi/riddle-me-this/releases/tag/v4.5.0
    - label: "Who's Rdd13r?"
      url: /maintainer/
classes: wide
permalink: /
...
:resume: https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v4.5.0/VadimKuhay-Resume.pdf
