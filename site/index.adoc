...
:who-i-write-for: link:{site-baseurl}/about/#who-i-write-for[Who I write for?,window=_blank]
...
== Hacker Forecast: link:{site-baseurl}/series[Trends You Won't Hear from Gartner]

- link:{site-baseurl}/series/final-industrial-revolution/[2023: The Final Industrial Revolution]
→ The herald in Wetware Revolution; the last revolution.

- link:{site-baseurl}/series/rupture-war-of-gods/[2022: Scarcity brings back Engineering]
→ Hardware wall + War for Survival => Pure Brilliance.

- link:{site-baseurl}/series/fall-of-democracy/[2025: Kakistocracy & Circus Maximus]
