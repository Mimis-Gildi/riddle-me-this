...
header:
  ...
  actions:
    - label: "Résumé PDFs (GitHub)"
      url: https://github.com/Mimis-Gildi/riddle-me-this/releases/tag/v1.3.0
    - label: "Who's Rdd13r?"
      url: /maintainer/
classes: wide
permalink: /
...
_See a release bundle at 🔗 link:https://github.com/Mimis-Gildi/riddle-me-this/releases/tag/v1.3.0[v1.3.0,window=_blank]_
