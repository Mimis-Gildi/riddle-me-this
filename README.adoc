...
== 📄 Résumé Release v2.2.0

This repo includes three curated PDFs packaged with each release.
Grab the latest from the GitHub Releases page:

📦 https://github.com/Mimis-Gildi/riddle-me-this/releases/tag/v2.2.0[v1.4.0] – full release package

* https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v2.2.0/OnEngineering.pdf[Engineering Résumé] – code, systems, and production
* https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v2.2.0/OnCreativity.pdf[Creative Résumé] – teams, products, and vision
* https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v2.2.0/OnLeadership.pdf[Leadership Résumé] – transformation, innovation, CTO roles
