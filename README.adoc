...
_P.P.S. This repo has human and AI contributors working as a flat team. See link:CONTRIBUTING.adoc[CONTRIBUTING] and link:TEAM_NORMS.adoc[TEAM_NORMS]._
...
📦 https://github.com/Mimis-Gildi/riddle-me-this/releases/tag/v3.19.0[v3.19.0] – full release package, automatically updated:

* https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v3.19.0/OnEngineering.pdf[Engineering Résumé] – code, systems, production, clever tricks;
* https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v3.19.0/OnCreativity.pdf[Creative Résumé] – teams, products, mistakes, storytelling, vision;
* https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v3.19.0/OnLeadership.pdf[Leadership Résumé] – transformation, innovation, past CTO roles;
* https://github.com/Mimis-Gildi/riddle-me-this/releases/download/v3.19.0/OnCore.pdf[Core Résumé] – ATS optimized simple document for your Rolodex.
