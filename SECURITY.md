...
The following diagrams reflect the current **Riddle-Me-This Secure Release Governance ([v2.22.0])** pipeline as of this release. IDE side enablements, i.e., the fluent workflow, are out of the documentation scope.
...
[v2.22.0]: https://github.com/Mimis-Gildi/riddle-me-this/releases/tag/v2.22.0 "This release tag to follow."
