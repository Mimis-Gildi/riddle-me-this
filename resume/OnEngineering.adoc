...
* 1995-1997: Core practice consultant, mainframe daemon development: C/ObjC/C++/Python/shell.
* 1992-1995: Entry level developer: Unix, C++, C, Python, Perl, SQL, bash, ksh, csh, BBS (Various).
* 1991–1992: Intern, BBS operator; C, C++, Python, Perl, Unix, bash, SQL | Colleges mentoring.
