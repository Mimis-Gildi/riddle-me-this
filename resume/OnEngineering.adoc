...
Polyglot software engineer, hands-on architect, and player-coach with decades of experience in system design,
...
* 3 decades in architecture, delivery, and coaching across startups, Fortune 500, defense, and research.
...
ASE (Principal Architect | Co-Founder, 2024–Present) -- Advanced Systems Engineering::
...
GEICO via Dexian (Staff Engineer, 2024) --  Domain Product Engineering::
...
ASE (Principal Architect | Co-Founder, 2017–2024) -- Platform Engineering::
...
Deutsche Bank (Lead Engineer, AVP, 2012–2017) -- Platform Engineering::
...
Xybion Corporation (Product Principal, 2010–2012) -- Systems Engineering::

* Designed and delivered market-leading content federation appliance, XFIS, purchased by EMC.

Glemser Technologies Corp (Lead Engineer, 2006–2010) -- Platform Engineering::
...
MassivelyParallel (Co-Founding Engineer, 2000–2005) -- Systems Engineering::

* Designed and delivered a suite of distributed systems for defense and warfare simulation. +
(Company acquired by CSC; AIOps IP acquired by IMPERISOFT, ASE: MATILDA predecessor)

Immigrant-Developers (Programmer to Software Engineer, 1991–1997) -- Software Development::

* 1995-1997: Core practice consultant, mainframe daemon development: C/ObjC/C{plus}{plus}/Python/shell.
* 1992-1995: Entry level developer: Unix, C{plus}{plus}, C, ObjC, Python, Perl, SQL, bash, ksh, csh, BBS (Various).
* 1991–1992: Intern, BBS operator; C, C{plus}{plus}, Python, Perl, Unix, bash, SQL | Colleges mentoring.
